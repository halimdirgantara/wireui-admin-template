    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="flat-sidebar fixed inset-y-0 left-0 z-50 w-64 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0"
            ...
            <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-700">
                ...
                <!-- Mobile close button -->
                <button @click="sidebarOpen = false" class="lg:hidden p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
            ...
            <header class="flat-header mx-4 mt-4 mb-0 px-6 py-4 flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <button @click="sidebarOpen = true" 
                            class="lg:hidden p-2 rounded-lg flat-button">
                ...
                <div class="flex items-center space-x-4">
                    <!-- Notifications -->
                    <button class="p-2 rounded-lg flat-button relative">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button @click="toggleDarkMode()" 
                            class="p-2 rounded-lg flat-button">
