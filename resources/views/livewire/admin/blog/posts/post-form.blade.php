            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
                    <div class="border-b border-gray-200/50 dark:border-gray-700/50">
                        <nav class="flex space-x-8 px-6" aria-label="Tabs">
                            <button 
                                ...
                                class="py-4 px-1 border-b-2 font-medium text-sm transition-colors {{ $activeTab === 'content' ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300' }}"
                            >
                            ...
                            <button 
                                ...
                                class="py-4 px-1 border-b-2 font-medium text-sm transition-colors {{ $activeTab === 'seo' ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300' }}"
                            >
                            ...
                            <button 
                                ...
                                class="py-4 px-1 border-b-2 font-medium text-sm transition-colors {{ $activeTab === 'social' ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300' }}"
                            >
                            ...
                            <button 
                                ...
                                class="py-4 px-1 border-b-2 font-medium text-sm transition-colors {{ $activeTab === 'advanced' ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300' }}"
                            >
                    ...
                    <div class="p-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <div class="flex items-center gap-2 mb-2">
                                        ...
                                        <x-button 
                                            type="button"
                                            wire:click="generateSlugFromTitle" 
                                            flat 
                                            size="sm"
                                        >
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        @if($current_featured_image)
                                            <div class="mb-4">
                                                <img 
                                                    src="{{ asset('storage/' . $current_featured_image) }}" 
                                        ...
                                        @if($featured_image_upload)
                                            <div class="mt-2">
                                                <img 
                                                    src="{{ $featured_image_upload->temporaryUrl() }}" 
                                                    alt="Preview" 
                                                    class="w-32 h-20 object-cover rounded-lg"
                                                >
                                    ...
                                    <div class="mt-2 space-y-3">
                                        ...
                                        <div class="relative">
                                            ...
                                            @if(count($suggestedTags) > 0)
                                                <div class="absolute z-10 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg">
                                                    @foreach($suggestedTags as $tag)
                                                        <button 
                                                            type="button"
                                                            wire:click="addTag({{ $tag->id }})"
                                                            class="w-full px-3 py-2 text-left hover:bg-gray-50 dark:hover:bg-gray-700 first:rounded-t-lg last:rounded-b-lg"
                                                        >
                                                            <span class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full {{ $tag->color_class }} mr-2">
                                                                {{ $tag->name }}
                                                            </span>
                        ...
                        @if($activeTab === 'seo')
                            <div class="space-y-6">
                                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200/50 dark:border-blue-700/50 rounded-lg p-4">
                                    <div class="flex items-start gap-3">
                                        <x-icon name="information-circle" class="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                                        <div>
                                            <h3 class="font-medium text-blue-800 dark:text-blue-200">SEO Optimization</h3>
                                            <p class="text-sm text-blue-600 dark:text-blue-300 mt-1">
                                                If SEO fields are left empty, they will auto-generate from your title and content.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {{-- SEO Preview --}}
                                <div class="bg-gray-50 dark:bg-gray-900/50 border border-gray-200/50 dark:border-gray-700/50 rounded-lg p-4">
                        ...
                        @if($activeTab === 'social')
                            <div class="space-y-6">
                                <div class="bg-purple-50 dark:bg-purple-900/20 border border-purple-200/50 dark:border-purple-700/50 rounded-lg p-4">
                                    <div class="flex items-start gap-3">
                                        <x-icon name="share" class="w-5 h-5 text-purple-500 flex-shrink-0 mt-0.5" />
                                        <div>
                                            <h3 class="font-medium text-purple-800 dark:text-purple-200">Social Media</h3>
                                ...
                                <div>
                                    <x-select
                                        wire:model="twitter_card"
                                        label="Twitter Card Type"
                                        :option-label="'label'"
                                        :option-value="'value'"
                                        :options="collect($twitterCardOptions)->map(fn($label, $value) => ['label' => $label, 'value' => $value])->values()"
                                    />
                                </div>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900/50 border border-gray-200/50 dark:border-gray-700/50 rounded-lg p-4">
                                    ...
                                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden max-w-md">
                                        @if($og_image || $current_featured_image)
                                            <div class="aspect-video bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                                                @if($og_image)
                                                    <img src="{{ $og_image }}" alt="OG Image" class="w-full h-full object-cover">
                                                @elseif($current_featured_image)
                                                    <img src="{{ asset('storage/' . $current_featured_image) }}" alt="Featured Image" class="w-full h-full object-cover">
                                                @endif
                                            </div>
                                        @endif
                                        <div class="p-3">
                    ...
                    <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl p-6 border border-gray-200/50 dark:border-gray-700/50">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white">{{ number_format($post->views_count ?? 0) }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600 dark:text-gray-400">Reading Time:</span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $post->reading_time ?? 1 }} min</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600 dark:text-gray-400">Created:</span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $post->created_at->format('M d, Y') }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600 dark:text-gray-400">Updated:</span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $post->updated_at->format('M d, Y') }}</span>
                            </div>
                        </div>
                    </div>
                @endif
